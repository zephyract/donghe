...
#define AP_CMD_DVP_SET                          0x04    // DVP setup
    ...
    #define AP_CMD_SET_DIVXHT31_SUB     0x22    //Divx HT3.1 Subtitle (EV_ON ~ EV_OFF)
...
#define AP_CMD_FUNC_SWITCH_SLIDE_EFFECT         0x73    // set slide show effect.
...
//Get DRM  CODE
#define AP_CMD_DRM_ACTIVATE_CODE                0x8b   //DRM activate code
#define AP_CMD_DRM_DEACTIVATE_CODE              0x8c   //DRM deactivate code
#define AP_CMD_DRM_RENT_CHK                     0x8d   //DRM rent check
...
#define DVP_CMD_FL_TYPE_COUNT_IN_DISC           0x39    // file counts by type(video,audio,pic) in current DISC
...
#define DVP_CMD_PBC_ADO_FILE_PATH               0x6b    // audio playing file path
...
#define DVP_CMD_PBC_AUDIO_PLAY_INFO_BY_PLAY_TYPE 0x74   //Data Disc(mp3), playing file info by play type in current dir.
#define DVP_CMD_PBC_PLAY_INFO_BY_PLAY_TYPE       0x75   //Data Disc(jpg&mps), playing file info by play type in current dir.
#define DVP_CMD_MPS_LOAD_PROGRESS               0x76

#define DVP_CMD_CREATE_FSTAB_OK                 0x78
#define DVP_CMD_SAVE_FILE_TYPE                  0x79

#define DVP_CMD_DISC_ID                         0x81
...
#define DVP_CMD_DRM_SAVE_DATA     0xA6	// tell AP save the DRM data to file.

//Divx DRM Error
#define DVP_CMD_DRM_AUTH_ERROR                  0xA7
#define DVP_CMD_DRM_RENT_EXPIRED                0xA8
#define DVP_CMD_DRM_RENT_CONFIRM                0xA9
