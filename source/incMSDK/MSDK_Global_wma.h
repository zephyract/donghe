...
*			   
*	@see	MediaGraph_Wma_Create()
*	@see	msdk_error.h
*
*	@note	must be called before msdk api used
**/
#if MSDK_FULLSCREEN
MRESULT     MSDK_Wma_Init(HWND hWnd,LPDIRECTDRAWSURFACE pddPrimary);
#else
...
**/
MRESULT     MSDK_Wma_InitThreadContext(GVOID);
...
*	@note	not implemented
**/
MRESULT     MSDK_Wma_UninitThreadContext(GVOID);
...
*	@see	E_MSDK_STATE
**/
MRESULT     MSDK_Wma_GetState(E_MSDK_STATE *peState);
