...
**/
MRESULT     AudioInfo_Wma_GetSampleRate(HAUDIOINFO hAudioInfo, GUINT32 *pu4SampleRate);
...
*	@note	 Not implemented
**/
MRESULT     AudioInfo_Wma_GetCodec(HAUDIOINFO hAudioInfo, E_MSDK_AVCODEC *peCodecID);
/**
*@}
*/
...
*	@see	 E_MSDK_AUDPROC
**/
MRESULT     AudioCtrl_Wma_SetPostProcess(HAUDIOCTRL hAudioCtrl, E_MSDK_AUDPROC eProcType);
...
*	@see	 msdk_error.h
**/
MRESULT     AudioCtrl_Wma_GetCurrentLyricItem(HAUDIOCTRL hAudioCtrl, GINT32 *pi4Current);
/**
*@}
*/
