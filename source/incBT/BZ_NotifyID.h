...
#define BZ_IND_AVRCP_REMOTE_NOTIFY_EVENT		BZIND_CODE( BZ_MODULE_MUSIC, 14 )
#define BZ_IND_A2DP_REMOTE_OPEN_OK		        BZIND_CODE( BZ_MODULE_MUSIC, 15 )


//SPP
#define BZ_IND_SPP_CONNECTED                    BZIND_CODE( BZ_MODULE_SPP, 1 )
#define BZ_IND_SPP_DISCONNECTED                 BZIND_CODE( BZ_MODULE_SPP, 2 )
#define BZ_IND_SPP_CONNECT_FAIL                 BZIND_CODE( BZ_MODULE_SPP, 3 )
#define BZ_IND_SPP_CONNETC_STATUS_CHANGE        BZIND_CODE( BZ_MODULE_SPP, 4 )
//DUN
...
#define BZ_IND_PBAP_START_OVER                  BZIND_CODE( BZ_MODULE_PBMGR, 7 )
...
//HID
#define BZ_IND_HID_CONNECTED                    BZIND_CODE( BZ_MODULE_HID, 1 )
#define BZ_IND_HID_DISCONNECTED                 BZIND_CODE( BZ_MODULE_HID, 2 )
#define BZ_IND_HID_CONNECT_REQUEST_FAIL         BZIND_CODE( BZ_MODULE_HID, 3 )
